...
using B10TestUtilities.AutoFixture;
...
namespace Blue10CLI.Tests.Services
{
    public class VendorServiceTests
    {
        ...
        public async Task CreateOrUpdate_Update_Success(
            ...
            [FromType(typeof(VendorService))] IVendorService pVendorService)
        {
            // Setup services
            ...
            fResult.Should().BeOfType<VendorResultModel>();
            fResult.ErrorMessage.Should().BeNull();
            fResult.Vendor.Should().Be(pVendorResult);
        }
